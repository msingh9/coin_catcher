## Notice of copyright
"""
This code is from book "Practical Deep Reinforcement Learning with Python" by Ivan Gridin.
"""
...
class CatchCoinsScreen:
    ...
    def update(self, display, plane_pos, total_score, remaining_turns):
        import pygame
        self.scr.fill(WHITE)
        ...
        self.scr.blit(self.font.render(f'Total: {total_score}({remaining_turns})', True, BLACK), (10, 10))
